...
class TocMachine(GraphMachine):
    ...
    def inputing_gender(self, event):
        title = '請先提供您的基本資訊'
        text = '生理性別『男生』還是『女生』'
        btn = [
    ...
    def inputing_height(self, event):
    ...
    def inputing_weight(self, event):
    ...
    def choosing_exercise_or_kcal(self, event):
    ...
    def getting_video(self, event):
        url = 'https://www.youtube.com/results?search_query=' + '健身+' + '胸'
        r = requests.get(url)
