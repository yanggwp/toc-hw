...
machine = TocMachine(
    ...
    transitions=[
        {'trigger': 'advance', 'source': 'user', 'dest': 'input_gender', 'conditions': 'is_going_to_gender'},
        ...
        {'trigger': 'advance', 'source': 'choose', 'dest': 'exercise', 'conditions': 'exercising'},
        {'trigger': 'advance', 'source': 'choose', 'dest': 'show_kcal', 'conditions': 'showing_kcal'},
        {'trigger': 'advance', 'source': 'exercise', 'dest': 'show_video', 'conditions': 'is_going_to_exercise'},
        {'trigger': 'advance', 'source': 'show_video', 'dest': 'get_video', 'conditions': 'is_going_to_showvideo'},
        {'trigger': 'advance', 'source': 'show_video', 'dest': 'get_video', 'conditions': 'is_going_to_get_video'},
        {'trigger': 'advance', 'source': 'show_kcal', 'dest': 'output_BMR_TDEE', 'conditions': 'showing_kcal'},
        {'trigger': 'advance', 'source': 'show_kcal', 'dest': 'choose', 'conditions': 'is_going_to_choose'},
        {'trigger': 'advance', 'source': 'show_video', 'dest': 'exercise', 'conditions': 'is_going_to_exercise'},
        {'trigger': 'advance', 'source': 'get_video', 'dest': 'choose', 'conditions': 'is_going_to_choose'},
        {
            'trigger': 'go_back',
            'source': [
                'input_gender',
    ...
    for event in events:
        ...
        if response == False:
            if event.message.text.lower() == 'fsm':
                send_image_message(event.reply_token, 'https://de4f-111-242-48-199.ngrok.io/show-fsm')
